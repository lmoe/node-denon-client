...
class DenonClient extends Connection {
   ...
   *
   * @method setVideoSelect
   * @param {VideoSelectOptions} videoSelectOptions [The video select option]
   * @return {Promise} [A response]
   */
  setVideoSelect(videoSelectOptions) {

    return this.sendCommand('VS', videoSelectOptions,
  ...
  getVideoSelectMode() {
    ...
    return this.sendCommand('VS', Options.VideoSelectOptions.Status,
      this.getEvent('videoSelect'));
  }
